...
var msg = "${msg}";
	...
	$(function(){
        ...
        $('#term').autocomplete({"source":function(request,response){
               ...
               $.getJSON("/evenetBoard/search",{"term":request.term},
            		  function(result){
...
<body>
	<div class="form-wrap">
       ...
       <label class="label-icon" for="term"><i class="small material-icons" style="color:#64b5f6;">subdirectory_arrow_right</i></label>
          ...
          <input id="term" type="text" name="title">
      ...
      <div class="section-wrap">
        ...
        <tbody>
          ...
          <c:forEach items="${searchList }" var="eventBoard">
            <tr>
	...
	<div class="pagination">
			...
			<c:if test="${paging.prev }">
				<li><a href="searchPage?page=${paging.startPage -1 }">&laquo;</a></li>
			</c:if>
			...
			<c:forEach begin="${paging.startPage }"
				...
				<li
					...
					<a href="searchPage?page=${idx }&title=${title}">${idx }</a>
				</li>
			</c:forEach>
			
			<c:if test="${paging.next && paging.endPage > 0 }">
				<li><a href="searchPage?page=${paging.endPage +1}">&raquo;</a></li>
				</c:if>
		</ul>
